            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="bg-dark-900/80 backdrop-blur-xl border border-dark-800 rounded-2xl p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        {/* Email */}
                        <div>
                            <label className="block text-dark-400 text-sm mb-2">Work email</label>
                            <div className="relative">
                        ...
                        {/* Password */}
                        <div>
                            <label className="block text-dark-400 text-sm mb-2">Password</label>
                            <div className="relative">
                    ...
                    <div className="mt-6 space-y-2">
                        <Benefit text="See real traffic metrics immediately" />
                        <Benefit text="Identify AI agents visiting your site" />
                        <Benefit text="5-minute setup, no code changes needed" />
                    </div>
                    ...
                    <p className="text-center mt-6 text-dark-500 text-sm">
                        ...
                        <Link href="/terms" className="text-primary-400 hover:text-primary-300">Terms</Link>
                        {' '}and{' '}
